const FinancialAdvisor = Object.create(null, {
    ...
    purchase: {
        ...
        value: function (ticker, quantity, price) {
            this.portfolio.push(
                {
                    ticker, quantity, price, purchase: true
                }
            )
        }
    },
    sell: {
        ...
        value: function (ticker, quantity, price) {
            this.portfolio.push(
                {
                    ticker, quantity, price, purchase: false
                }
            )
...
FinancialAdvisor.purchase("TSLA", 1000, 297.60)
FinancialAdvisor.sell("TSLA", 250, 297.60)
